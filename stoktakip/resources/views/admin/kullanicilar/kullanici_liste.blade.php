...
@section('admin')
    ...
    <div class="content-wrap">
        <div style="background-color: #647efc">
            <h4 style="color: white" class="text-center mt-4">Kullanıcılar Listesi</h4>
            <a href="{{route('kullanici.ekle')}}">
                <button type="button" class="btn btn-primary waves-effect waves-light mr-2" style="float: right"><i class="ti-plus"></i> Kullanıcı Ekle</button>
            </a>
        </div>
                            ...
                            <div class="table-responsive">
                                <div id="bootstrap-data-table-export_wrapper"
                                    ...
                                    <table id="bootstrap-data-table-export"
                                        ...
                                        <tbody>
                                        @foreach($kullanici_liste as $kullanici)
                                            <tr role="row" class="odd">
                                                ...
                                                <td>
                                                    @foreach($kullanici->roles as $rol)
                                                        <span class="badge badge-pill bg-success">{{ $rol->name }}</span>
                                                    @endforeach
                                                </td>
                                                <td>
                                                    <a href="{{ route('kullanici.duzenle',$kullanici->id) }}" class="btn btn-info sm m-2 ti-pencil-alt" title="Düzenle">
                                                    </a>
                                                    <a href="{{ route('kullanici.sil', $kullanici->id) }}" class="btn btn-danger sm ti-trash" title="Sil" id="sil">
                                                    </a>
                                                </td>
                                            </tr>
