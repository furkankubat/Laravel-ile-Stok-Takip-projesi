...
@section('admin')
    <div class="content-wrap">
        <div style="background-color: #647efc">
            <h4 style="color: white" class="text-center mt-4">Roller Listesi </h4>
            <a href="{{route('rol.ekle')}}">
                <button type="button" class="btn btn-primary waves-effect waves-light mr-2" style="float: right"><i class="ti-plus"></i> Rol Ekle</button>
            </a>
        </div>
                                    ...
                                    <table id="bootstrap-data-table-export"
                                        ...
                                        @foreach($roller as $rol)
                                            <tr role="row" class="odd">
                                                ...
                                                <td>{{ $rol->name }}</td>
                                                <td>
                                                    <a href="{{ route('rol.duzenle',$rol->id) }}" class="btn btn-info sm m-2 ti-pencil-alt" title="Düzenle">
                                                    </a>
                                                    <a href="{{ route('rol.sil', $rol->id) }}" class="btn btn-danger sm ti-trash mr-2" title="Sil" id="sil">
                                                    </a>
